            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full text-center"
                    ...
                    <p className="text-gray-500 text-sm mb-2">
                        Sua solicitação para a <strong className="text-gray-700">{salaSelecionada?.nomeSala || salaSelecionada?.nome || 'sala'}</strong> foi registrada.
                    </p>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-4 mb-8 text-left space-y-2">
                        ...
                        <Row label="Sala"    value={salaSelecionada?.nomeSala || salaSelecionada?.nome} />
                                        ...
                                        <select className={`${inputClass} pl-10 appearance-none`} required
                                            ...
                                            {salas.map(s => (
                                                <option key={s.id} value={s.id}>
                                                    {s.nomeSala || s.nome} — {(s.tipoSala || s.tipo || '').toLowerCase().includes('lab') ? 'Laboratório' : 'Sala de Aula'}
                                                </option>
                                            ))}
                                        </select>
